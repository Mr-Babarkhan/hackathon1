...
async function fetchAllProductsData() {
  let res = await fetch(`https://${process.env.NEXT_PUBLIC_SANITY_PROJECT_ID}.api.sanity.io/v2023-08-23/data/query/production?query=*%5B_type%3D%3D%22products%22+%26%26+productTypes%5B0%5D+%3D%3D%22kid%22%5D`, {
    next: {
      revalidate: 60
    }
  });
